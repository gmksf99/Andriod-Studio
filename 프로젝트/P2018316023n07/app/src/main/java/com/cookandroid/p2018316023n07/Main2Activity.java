...
public class Main2Activity extends AppCompatActivity {
    ...
    BufferedReader br;
    String[] title, link, bloggername, postdate;
    TextView textView;
    Parser mMyAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setTitle("조회 리스트");
        String title = "";  //title 저장할 공간
        Bundle extras = getIntent().getExtras();    // 받아옴
        if (extras == null) {
            title = "error";
        }
        else {
        ...
        Button btnFin = findViewById(R.id.button2);
    ...
    public void searchNaver(final String searchObject) {
        final String clientId = "QkGRxCCxRXq6gCA_eslb";
        final String clientSecret = "DFWzyq8MJN";
